...
// SQLD 모의고사 2회 (기본 난이도 - 실제 시험의 75% 수준)
...
export const EXAM_2_PROBLEMS: Problem[] = [
  ...
  {
    id: 'exam2_p20',
    title: '20. UNPIVOT의 개념',
    description:
      'Oracle UNPIVOT에 대한 설명으로 올바르지 않은 것은?',
    type: 'multiple_choice',
    difficulty: 'easy',
    ...
    answer: '4',
    explanation:
      'UNPIVOT은 열 데이터를 행으로 변환합니다. PIVOT과 반대 개념이며, 여러 컬럼에 분산된 데이터를 하나의 컬럼으로 통합할 때 사용합니다. UNPIVOT에는 집계함수가 필요하지 않습니다. PIVOT에만 집계함수가 필수입니다.',
    options: [
      'UNPIVOT은 열 데이터를 행으로 변환한다.',
      'UNPIVOT은 PIVOT의 역변환 기능을 수행한다.',
      'UNPIVOT은 여러 컬럼을 하나의 컬럼으로 통합할 수 있다.',
      'UNPIVOT에는 SUM, COUNT 등 집계함수가 반드시 필요하다.',
    ],
    points: 10,
  },
  ...
  {
    id: 'exam2_p21',
    title: '21. REGEXP_REPLACE 함수',
    description:
      '다음 SQL의 실행 결과로 올바른 것은?\n\n```sql\nSELECT REGEXP_REPLACE(\'010-1234-5678\', \'[^0-9]\', \'\') AS RESULT\nFROM DUAL;\n```',
    type: 'multiple_choice',
    difficulty: 'easy',
    category: '정규표현식',
    correctRate: 75,
    answer: '1',
    explanation:
      'REGEXP_REPLACE는 정규표현식 패턴에 매칭되는 부분을 치환합니다. [^0-9]는 숫자가 아닌 모든 문자를 의미하므로, 하이픈(-)이 모두 제거되어 01012345678이 반환됩니다.',
    options: [
      '01012345678',
      '010-1234-5678',
      '1234-5678',
  ...
  {
    id: 'exam2_p38',
    title: '38. ROW_NUMBER()를 이용한 Top N',
    description:
    ...
    answer: '3',
    explanation:
      'ROW_NUMBER()는 정렬 기준에 따라 고유한 순번을 부여합니다. SALARY DESC로 정렬하므로 급여가 가장 높은 순서대로 번호가 부여되며, RN <= 5로 상위 5명만 추출됩니다. ROWNUM 방식과 달리 정렬이 보장되어 더 안전한 Top N 쿼리 방식입니다.',
    options: [
      '급여가 가장 낮은 5명을 조회한다.',
      '모든 사원의 급여 순위를 표시한다.',
      '급여 상위 5명을 정확하게 조회한다.',
      'ROW_NUMBER() 대신 ROWNUM을 사용해도 동일한 결과가 나온다.',
    ],
    points: 10,
  },
  {
